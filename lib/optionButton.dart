  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      print('answerchoice1, $answerchoice');
         if (answerchoice==widget.choice1 && widget.choice1==0 && abb==0 ) {
         ...
         else { if (answerchoice==widget.choice1 && widget.choice1==1 && abb==0 ){
           ...
           if (answerchoice==widget.choice1 && widget.choice1==2 && abb==0 ){
             clr2=Color.fromRGBO(68, 193, 12, 1);
             abb++;
             Future.delayed(const Duration(seconds: 3), () {
               incrementOfjson();
             }) ;
           }else{if (answerchoice==widget.choice1 && widget.choice1==3 && abb==0){
